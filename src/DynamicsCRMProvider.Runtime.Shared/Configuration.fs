/// [omit]
module FSharp.Data.TypeProviders.XrmProvider.Internal.Configuration
...
/// Returns the Assembly object of FSharp.Data.DynamicsCRMProvider.dll
let getCRMProviderRuntimeAssembly() =
  AppDomain.CurrentDomain.GetAssemblies()
  |> Seq.find (fun a -> a.FullName.StartsWith("FSharp.Data.DynamicsCRMProvider.Runtime,"))
...
/// Reads the 'FSharp.Data.DynamicsCRMProvider.dll.config' file and gets the 'ProbingLocations'
/// parameter from the configuration file. Resolves the directories and returns
/// them as a list.
let getProbingLocations() =
  try
    let root = getCRMProviderRuntimeAssembly() |> getAssemblyLocation
